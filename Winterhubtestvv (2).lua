game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16761484432";
      Title = "Winter hub nokey", 
      Text = "No Key For Now!!",
       Button1 = "Ok cool",
  })
...
wait(1)
LOADING.Text = "Script Winter hub nokey"
...
local listfastattack = {'Normal','Slow','Super'}
	...
	if _G.FastAttackFaiFao_Mode == "Slow" then
		_G.Fast_Delay = 0.09
	elseif _G.FastAttackFaiFao_Mode == "Normal" then
		_G.Fast_Delay = 0.16
	elseif _G.FastAttackFaiFao_Mode == "Super" then
		_G.Fast_Delay = 0
	end
end)
...
Tabs.Main:AddButton({
    Title = "Auto Farm Chest ON",
    Description = "",
    Callback = function()
        _G.JoinTeam = "Pirates"
        _G.Stop_If_Has_Items = true
        loadstring(game:HttpGet("https://shz.al/~Winterhubautofarmchest"))()
    end
})
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Bypass Reset Collect Devil Fruit",Description = "", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Move Collect Devil Fruit",Description = "", Default = false })
...
local ToggleKillPlayerTrial = Tabs.Race:AddToggle("ToggleKillPlayerTrial", {Title = "Auto Kill player",Description = "", Default = false })
