...
-- print (info)
    ...
    print("Hiru x hub")
    print("Tham Gia Zalo : https://dsc.gg/m1m")
...
task.delay(1 * 10,function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow> Tham Gia Zalo : https://dsc.gg/m1m <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Purple> ty for using Hiru Hub - have fun:P <Color=/>"):Display()
...
ImageButton.Image = "rbxassetid://16654955517"
