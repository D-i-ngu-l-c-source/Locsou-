...
local Tabs = {
    ...
    Hop = Window:AddTab({ Title = "đổi sv", Icon = "user" }),
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( Chỉ Cấp Max thôi nè )",Description = "( Chỉ có level max)", Default = false })
...
if Second_Sea then
    ...
    spawn(function()
        while wait() do
            ...
            if Third_Sea then
         local AutoKillAdmin = Tabs.Main:AddToggle("Auto Đánh Admin",Description = "", Default = false })
         AutoKillAdmin:OnChanged(function(Value)
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Đổi xương nè",Description = "", Default = false })
